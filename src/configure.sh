...
docker exec magento2-container bin/magento config:set payment/adyen_applepay/express_show_on "1,2,3"
docker exec magento2-container bin/magento config:set payment/adyen_googlepay/express_show_on "1,2,3"
